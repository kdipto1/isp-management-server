...
const signup = async (payload) => {
    ...
    if (isUserExists)
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'User already exits by this contact number or email');
    if (payload) {
...
const login = async (payload) => {
    ...
    if (!contactNo || !password)
        throw new ApiError_1.default(http_status_1.default.UNAUTHORIZED, 'Contact No and Password Required');
    ...
    const isPasswordCorrect = await bcrypt_1.default.compare(password, isUserExists.password);
